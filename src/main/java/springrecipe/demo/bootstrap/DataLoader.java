package springrecipe.demo.bootstrap;
...
import springrecipe.demo.domain.*;
import springrecipe.demo.repositories.CategoryRepository;
...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipe(){
        ...
        Optional<UnitOfMeasure> tablespoonUopOptional = unitOfMeasureRepository.findByDescription("Tablespoon");
        if(!tablespoonUopOptional.isPresent()){
            throw new RuntimeException("Expected UOM not found");
        }

        Optional<UnitOfMeasure> cupUopOptional = unitOfMeasureRepository.findByDescription("Cup");
        if(!cupUopOptional.isPresent()){
            throw new RuntimeException("Expected UOM not found");
        }

        Optional<UnitOfMeasure> pinchUopOptional = unitOfMeasureRepository.findByDescription("Pinch");
        if(!pinchUopOptional.isPresent()){
            throw new RuntimeException("Expected UOM not found");
        }
        Optional<UnitOfMeasure> ounceUopOptional = unitOfMeasureRepository.findByDescription("Ounce");
        if(!ounceUopOptional.isPresent()){
            throw new RuntimeException("Expected UOM not found");
        }
        Optional<UnitOfMeasure> ripeUopOptional = unitOfMeasureRepository.findByDescription("Ripe");
        if(!ripeUopOptional.isPresent()){
            throw new RuntimeException("Expected UOM not found");
        }
        Optional<UnitOfMeasure> dashUopOptional = unitOfMeasureRepository.findByDescription("Dash");
        if(!dashUopOptional.isPresent()){
            throw new RuntimeException("Expected UOM not found");
        }
        ...
        UnitOfMeasure tablespoonUom = tablespoonUopOptional.get();
        UnitOfMeasure cupUom = cupUopOptional.get();
        UnitOfMeasure pinchUom = pinchUopOptional.get();
        UnitOfMeasure ounceUom = ounceUopOptional.get();
        UnitOfMeasure ripeUom = ripeUopOptional.get();
        UnitOfMeasure dashUom = dashUopOptional.get();
        ...
        guacamole.addIngredients(new Ingredient("Kosher salt", new BigDecimal(".5"), teaspoonUom));
        ...
        guacamole.addIngredients(new Ingredient("ripe tomato, seeds and pulp removed, chopped", new BigDecimal(".5"), eachUom));
        ...
        tacosRecipe.addIngredients(new Ingredient("packed baby arugula", new BigDecimal(3), cupUom));
        ...
        tacosRecipe.addIngredients(new Ingredient("cherry tomatoes, halved", new BigDecimal(".5"), pinchUom));
        ...
        tacosRecipe.addIngredients(new Ingredient("cup sour cream thinned with 1/4 cup milk", new BigDecimal(4), cupUom));
